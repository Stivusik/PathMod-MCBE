...
```
```
const/4\s+v0,\s+0x0\s*(?:\R\s*\.line\s+\d+\s*)?\R\s*invoke-virtual\s+\{p0,\s*v0\},\s*Lcom/mojang/minecraftpe/MainActivity;->getExternalFilesDir\(Ljava/lang/String;\)Ljava/io/File;
```
